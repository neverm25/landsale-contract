...
contract ERC721BaseToken is Context, IERC721, SuperOperators, MetaTransactionReceiver {
    ...
    */
     ...
     * you can enable versioned tokenIds without the extra overhead of writing
     * to a new storage slot in _owners each time a version is incremented.
